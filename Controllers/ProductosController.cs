...
namespace SistemaUniversitario.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(dbSistemaUniversitarioContext context)
        {
            _context = context;
        }
        ...
        {
            var dbSistemaUniversitarioContext = _context.Producto.Include(p => p.IdcategoriaNavigation);
            return View(await dbSistemaUniversitarioContext.ToListAsync());
        }
